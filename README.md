...
![arcgis-map-event](https://img.shields.io/badge/arcgis--map--event-v1.0.3-%23C50008?logo=npm)
...
+ A：You can add a unique `arcgis_map_event_id` attribute to graph `attributes`.
    ```js
    new Graphic({
        geometry,
        attributes: {
